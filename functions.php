<?php
/**
 * comfortair functions and definitions
 *
 ...
 */
function comfort_air_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on comfortair, use a find and replace
		* to change 'comfort-air' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'comfort-air', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'comfort-air' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'comfort_air_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'comfort_air_setup' );
 ...
 */
function comfort_air_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'comfort_air_content_width', 640 );
}
add_action( 'after_setup_theme', 'comfort_air_content_width', 0 );
 ...
 */
function comfort_air_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'comfort-air' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'comfort-air' ),
...
add_action( 'widgets_init', 'comfort_air_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function comfort_air_scripts() {
